...
class Node:
    ...
    def __lt__(self, other):    # determines the greater/less than relationships by utilizing the heuristic values
...
def a_star(graph, start):   # taken from http://cyluun.github.io/blog/uninformed-search-algorithms-in-python and modified
    visited = []
    queue = []
    heapq.heapify(queue)
